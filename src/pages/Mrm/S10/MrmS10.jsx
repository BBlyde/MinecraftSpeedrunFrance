          ...
          <div className="rules-panel">
            ...
            <div className="rules-panel-body">
              <div className="rules-row">
                ...
                <span>La qualification aux MRM s'effectue en finissant parmi les 16 plus hauts élos au <Link to="/leaderboard/ranked" className="rules-link">classement Ranked MSF</Link> à la toute fin de la saison de MCSR Ranked</span>
              </div>
              <div className="rules-row">
